...
<head>
    ...
    <style>
        ...
        .container { background-color: #fff; padding: 35px; border-radius: 12px; box-shadow: 0 8px 24px rgba(0,0,0,0.1); max-width: 420px; width: 100%; border-top: 6px solid #0056b3; }
        .text-center { text-align: center; }
        .logo-placeholder { background: #0056b3; color: white; padding: 15px; border-radius: 8px; font-weight: bold; font-size: 24px; display: inline-block; margin-bottom: 20px; letter-spacing: 1px;}
        ...
        button { background-color: #0056b3; color: white; padding: 14px; border: none; border-radius: 6px; cursor: pointer; width: 100%; font-size: 15px; font-weight: bold; margin-top: 20px; transition: background 0.3s; }
...
<div class="container">
    <div class="text-center">
        <div class="logo-placeholder"><?= htmlspecialchars($app_config['nome_empresa']) ?></div>
        <h2>Acesso Wi-Fi</h2>
    ...
    <?php elseif ($acao == 'cadastro'): ?>
        <form method="POST" action="<?= urlAba('cadastro') ?>">
            ...
            <label>CPF (Será validado na Receita):</label>
